...
RESOURCE_CONFIG = {
    ...
    "clients": {
        ...
        "required": ["name"],
        "fields": ["type", "name", "document", "rg_ie", "email", "phone", "civil_status", "profession", "birth_date", "responsible_user_id", "origin", "notes", "status"],
        "soft_delete": True,
    },
    "client_contacts": {
    ...
    "cases": {
        ...
        "required": ["title"],
        "fields": ["client_id", "lawyer_id", "case_number", "title", "area", "court", "district", "court_branch", "phase", "status", "claim_value", "expected_fees", "notes"],
        "soft_delete": True,
    },
    "case_parties": {
        "table": "case_parties",
    ...
    "certificate_agents": {
        "table": "certificate_agents",
        "permission_read": "integrations.read",
        "permission_write": "integrations.write",
        "required": ["name", "agent_key"],
        "fields": ["name", "agent_key", "token_hash", "status", "last_seen_at", "metadata", "created_by"],
        "soft_delete": True,
    },
    "certificate_agent_jobs": {
        "table": "certificate_agent_jobs",
        "permission_read": "sync.read",
        "permission_write": "sync.write",
        "required": ["case_id"],
        "fields": ["case_id", "lawyer_id", "certificate_id", "connector_id", "agent_id", "assigned_agent_key", "job_type", "status", "request_payload", "response_payload", "error_message", "locked_at", "completed_at", "created_by"],
        "soft_delete": True,
    },
    "automation_rules": {
    ...
    "appointments": {
        ...
        "fields": ["client_id", "case_id", "title", "type", "mode", "start_at", "end_at", "location", "meeting_url", "reminder_minutes", "recurrence_rule", "notes", "status", "created_by"],
        "soft_delete": True,
    },
    "documents": {
        "table": "documents",
        ...
        "fields": ["client_id", "case_id", "category_id", "uploaded_by", "title", "file_url", "file_type", "mime_type", "size_bytes", "version_label", "origin", "expires_at", "status"],
        "soft_delete": True,
    },
    "document_categories": {
    ...
    "message_templates": {
        ...
        "required": ["name", "body"],
        "fields": ["name", "channel", "situation", "subject", "body", "active"],
    },
    "messages": {
        "table": "messages",
        ...
        "fields": ["client_id", "case_id", "template_id", "channel", "recipient", "subject", "body", "status", "scheduled_at", "sent_at", "delivered_at", "read_at", "provider", "provider_message_id", "error_message", "created_by"],
    },
    "financial_entries": {
    ...
    "tasks": {
        ...
        "required": ["title"],
        "fields": ["client_id", "case_id", "appointment_id", "assigned_user_id", "title", "description", "priority", "due_at", "status", "created_by"],
        "soft_delete": True,
    },
    "notifications": {
        "table": "notifications",
...
def _apply_filters(resource_name: str, sql: str, params: list) -> tuple[str, list]:
    allowed = {
        ...
        "clients": {"status", "type", "origin", "responsible_user_id"},
        ...
        "certificate_agents": {"agent_key", "status"},
        "certificate_agent_jobs": {"case_id", "certificate_id", "connector_id", "agent_id", "assigned_agent_key", "job_type", "status"},
        "automation_rules": {"trigger_type", "active"},
        "ai_summaries": {"entity", "entity_id", "summary_type", "status"},
        "appointments": {"status", "client_id", "case_id", "type", "mode"},
        "documents": {"status", "client_id", "case_id", "category_id", "origin", "file_type"},
        ...
        "message_templates": {"active", "channel", "situation"},
        "messages": {"status", "client_id", "case_id", "channel"},
        "financial_entries": {"entry_type", "status", "client_id", "case_id", "category"},
        "message_attachments": {"message_id"},
        "tasks": {"status", "client_id", "case_id", "appointment_id", "assigned_user_id", "priority"},
